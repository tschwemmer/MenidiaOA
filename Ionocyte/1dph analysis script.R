...
anova(lm(AverageTotalDensitymm~CO2*Temp,data=d3_emb[d3_emb$Experiment.x=="exp1",]))
summary(lm(AverageTotalDensitymm~CO2*Temp,data=d3_emb[d3_emb$Experiment.x=="exp1",]))

anova(lm(AverageTotalDensitymm~CO2*Temp,data=d3_1dph[d3_1dph$Experiment.x=="exp1",]))
summary(lm(AverageTotalDensitymm~CO2*Temp,data=d3_1dph[d3_1dph$Experiment.x=="exp1",]))

anova(lm(AverageTotalDensitymm~CO2*Temp,data=d3_emb[d3_emb$Experiment.x=="exp2",]))
summary(lm(AverageTotalDensitymm~CO2*Temp,data=d3_emb[d3_emb$Experiment.x=="exp2",]))

anova(lm(AverageTotalDensitymm~CO2*Temp,data=d3_1dph[d3_1dph$Experiment.x=="exp2",]))
summary(lm(AverageTotalDensitymm~CO2*Temp,data=d3_1dph[d3_1dph$Experiment.x=="exp2",]))

anova(lm(AverageTotalDensitymm~CO2*Temp,data=d3_emb[d3_emb$Experiment.x=="exp3",]))
summary(lm(AverageTotalDensitymm~CO2*Temp,data=d3_emb[d3_emb$Experiment.x=="exp3",]))

anova(lm(AverageTotalDensitymm~CO2*Temp,data=d3_1dph[d3_1dph$Experiment.x=="exp3",]))
summary(lm(AverageTotalDensitymm~CO2*Temp,data=d3_1dph[d3_1dph$Experiment.x=="exp3",]))

anova(lm(AverageTotalDensitymm~CO2*Temp,data=d3_emb[d3_emb$Experiment.x=="exp4",]))
summary(lm(AverageTotalDensitymm~CO2*Temp,data=d3_emb[d3_emb$Experiment.x=="exp4",]))

anova(lm(AverageTotalDensitymm~CO2*Temp,data=d3_1dph[d3_1dph$Experiment.x=="exp4",]))
summary(lm(AverageTotalDensitymm~CO2*Temp,data=d3_1dph[d3_1dph$Experiment.x=="exp4",]))
