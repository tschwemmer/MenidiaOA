...
-Embryo SD analysis
    -Yolk: There are 4 above 400, 7 above 300
      ...
      -Samples: 2016-373, 2016-456, 2016-457, 2016-458, 2016-525, 2016-542, 2016-544
        -2016-373: The second count is lower and area is higher so density is much lower. Analyzed R side both times. Actually looks like the second count was for the L side but entered into R side columns by accident. I will use the L side instead since that was counted twice. 
        -2016-456: Yolk Density 2 is much lower than 1, count is lower and area is higher. Used L for 1 and R for 2. Should probably pick one to redo so sides match. Replace R with L for 2nd count. 
