...
#P1A1<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$A1,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("A1",times=52),rep("1A",times=52),rep("amb",times=52))
#P1A2<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$A2,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("A2",times=52),rep("1A",times=52),rep("blank1",times=52))
P1A3<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$A3,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("A3",times=52),rep("1A",times=52),rep("amb",times=52))
P1A4<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$A4,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("A4",times=52),rep("1A",times=52),rep("amb",times=52))
P1A5<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$A5,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("A5",times=52),rep("1A",times=52),rep("amb",times=52))
P1A6<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$A6,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("A6",times=52),rep("1A",times=52),rep("amb",times=52))
P1B1<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$B1,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("B1",times=52),rep("3A",times=52),rep("high",times=52))
P1B2<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$B2,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("B2",times=52),rep("3A",times=52),rep("high",times=52))
P1B3<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$B3,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("B3",times=52),rep("3A",times=52),rep("high",times=52))
P1B4<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$B4,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("B4",times=52),rep("3A",times=52),rep("high",times=52))
#P1B5<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$B5,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("B5",times=52),rep("3A",times=52),rep("blank3",times=52))
P1B6<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$B6,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("B6",times=52),rep("3A",times=52),rep("high",times=52))
P1C1<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$C1,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("C1",times=52),rep("3C",times=52),rep("high",times=52))
#P1C2<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$C2,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("C2",times=52),rep("3C",times=52),rep("high",times=52))
P1C3<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$C3,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("C3",times=52),rep("3C",times=52),rep("blank3",times=52))
P1C4<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$C4,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("C4",times=52),rep("3C",times=52),rep("high",times=52))
P1C5<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$C5,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("C5",times=52),rep("3C",times=52),rep("high",times=52))
P1C6<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$C6,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("C6",times=52),rep("3C",times=52),rep("high",times=52))
P1D1<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$D1,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("D1",times=52),rep("1C",times=52),rep("amb",times=52))
P1D2<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$D2,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("D2",times=52),rep("1C",times=52),rep("amb",times=52))
P1D3<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$D3,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("D3",times=52),rep("1C",times=52),rep("amb",times=52))
P1D4<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$D4,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("D4",times=52),rep("1C",times=52),rep("amb",times=52))
P1D5<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$D5,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("D5",times=52),rep("1C",times=52),rep("amb",times=52))
#P1D6<-data.frame(calc_MO2(duration=lar_p1orig$Time.Min.,o2=lar_p1orig$D6,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p1orig$T_internal,sal=27.5),rep("D6",times=52),rep("1C",times=52),rep("blank1",times=52))

#P2A1<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$A1,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("A1",times=52),rep("2A",times=52),rep("blank2",times=52))
P2A2<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$A2,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("A2",times=52),rep("2A",times=52),rep("med",times=52))
P2A3<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$A3,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("A3",times=52),rep("2A",times=52),rep("med",times=52))
P2A4<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$A4,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("A4",times=52),rep("2A",times=52),rep("med",times=52))
P2A5<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$A5,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("A5",times=52),rep("2A",times=52),rep("med",times=52))
P2A6<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$A6,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("A6",times=52),rep("2A",times=52),rep("med",times=52))
#P2B1<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$B1,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("B1",times=52),rep("1B",times=52),rep("blank1",times=52))
P2B2<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$B2,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("B2",times=52),rep("2C",times=52),rep("med",times=52))
P2B3<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$B3,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("B3",times=52),rep("2C",times=52),rep("med",times=52))
P2B4<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$B4,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("B4",times=52),rep("2C",times=52),rep("med",times=52))
#P2B5<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$B5,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("B5",times=52),rep("2C",times=52),rep("blank2",times=52))
P2B6<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$B6,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("B6",times=52),rep("2C",times=52),rep("med",times=52))
#P2C1<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$C1,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("C1",times=52),rep("3B",times=52),rep("high",times=52))
P2C2<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$C2,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("C2",times=52),rep("3B",times=52),rep("high",times=52))
#P2C3<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$C3,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("C3",times=52),rep("3B",times=52),rep("high",times=52))
#P2C4<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$C4,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("C4",times=52),rep("3B",times=52),rep("blank3",times=52))
P2C5<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$C5,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("C5",times=52),rep("3B",times=52),rep("high",times=52))
P2C6<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$C6,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("C6",times=52),rep("3B",times=52),rep("high",times=52))
P2D1<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$D1,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("D1",times=52),rep("2B",times=52),rep("med",times=52))
P2D2<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$D2,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("D2",times=52),rep("2B",times=52),rep("med",times=52))
#P2D3<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$D3,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("D3",times=52),rep("2B",times=52),rep("med",times=52))
P2D4<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$D4,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("D4",times=52),rep("2B",times=52),rep("med",times=52))
P2D5<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$D5,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("D5",times=52),rep("2B",times=52),rep("med",times=52))
#P2D6<-data.frame(calc_MO2(duration=lar_p2orig$Time.Min.,o2=lar_p2orig$D6,o2_unit="mg_per_l",bin_width=30,vol=0.0005,temp=lar_p2orig$T_internal,sal=27.5),rep("D6",times=52),rep("2B",times=52),rep("blank2",times=52))
...
P1A3$dw<-rep(0.11375326,times=52)
P1A4$dw<-rep(0.11681336,times=52)
P1A5$dw<-rep(0.09922280,times=52)
P1A6$dw<-rep(0.10432513,times=52)
P1B1$dw<-rep(0.08709446,times=52)
P1B2$dw<-rep(0.09902456,times=52)
P1B3$dw<-rep(0.10209817,times=52)
P1B4$dw<-rep(0.11107118,times=52)
P1B6$dw<-rep(0.11923361,times=52)
P1C1$dw<-rep(0.14085895,times=52)
P1C3$dw<-rep(0.09655368,times=52)
P1C4$dw<-rep(0.12954792,times=52)
P1C5$dw<-rep(0.10568236,times=52)
P1C6$dw<-rep(0.13715155,times=52)
P1D1$dw<-rep(0.14086458,times=52)
P1D2$dw<-rep(0.09798792,times=52)
P1D3$dw<-rep(0.13085227,times=52)
P1D4$dw<-rep(0.13390428,times=52)
P1D5$dw<-rep(0.12593972,times=52)
P2A2$dw<-rep(0.10935514,times=52)
P2A3$dw<-rep(0.12358477,times=52)
P2A4$dw<-rep(0.08569174,times=52)
P2A5$dw<-rep(0.07806737,times=52)
P2A6$dw<-rep(0.11007652,times=52)
P2B2$dw<-rep(0.14804063,times=52)
P2B3$dw<-rep(0.13847522,times=52)
P2B4$dw<-rep(0.10507304,times=52)
P2B6$dw<-rep(0.11904125,times=52)
P2C2$dw<-rep(0.09615336,times=52)
P2C5$dw<-rep(0.15999001,times=52)
P2C6$dw<-rep(0.11356300,times=52)
P2D1$dw<-rep(0.12751676,times=52)
P2D2$dw<-rep(0.14018903,times=52)
P2D4$dw<-rep(0.12256590,times=52)
P2D5$dw<-rep(0.12119752,times=52)
